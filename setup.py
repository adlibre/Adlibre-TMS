...
setup(name='adlibre_tms',
    ...
    package_data={
            'adlibre_tms': [
                ...
                'apps/tms/static/js/*.js',
                'apps/tms/static/js/*.htc',
                'apps/tms/static/js/jquery-themes/base/*.css',
                'apps/tms/static/js/jquery-themes/base/images/*',
                'apps/tms/static/js/jquery-themes/ui-lightness/*.css',
                'apps/tms/static/js/jquery-themes/ui-lightness/images/*',
                'apps/tms/static/js/jquery-ui/*.js',
                'apps/tms/static/js/jquery-ui/i18n/*.js',
                'apps/tms/static/js/jquery-ui/minified/*.js',
                'static/uni_form/*',
                'templates/*.html',
