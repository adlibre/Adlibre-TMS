...
setup(name='adlibre_tms',
    ...
    data_files = [
            ...
            ('www/media', 'favicon.ico'),
#            ('www/media/blue_theme/tms/css', '*.css'),
#            ('www/media/blue_theme/tms/images', '*'),
#            ('www/media/blue_theme/tms/js', '*.js'),
#            ('www/media/blue_theme/tms/js', '*.htc'),
#            ('www/media/blue_theme/tms/js/jquery-themes/base', '*.css'),
#            ('www/media/blue_theme/tms/js/jquery-themes/base/images', '*'),
#            ('www/media/blue_theme/tms/js/jquery-themes/ui-lightness', '*.css'),
#            ('www/media/blue_theme/tms/js/jquery-themes/ui-lightness/images', '*'),
#            ('www/media/blue_theme/tms/js/jquery-ui', '*.js'),
#            ('www/media/blue_theme/tms/js/jquery-ui/i18n', '*.js'),
#            ('www/media/blue_theme/tms/js/jquery-ui/minified', '*.js'),
#            ('www/media/blue_theme/uni_form', '*'),
        ],
    install_requires=[
            'BeautifulSoup==3.2.0',
            'Django==1.3.1',
