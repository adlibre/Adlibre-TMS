...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.service_price'
        db.delete_column('tms_service', 'service_price')

        # Deleting field 'Service.service_currency'
        db.delete_column('tms_service', 'service_currency_id')

        # Adding field 'Job.price'
        db.add_column('tms_job', 'price',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Job.currency'
        db.add_column('tms_job', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tms.Currency'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.service_price'
        db.add_column('tms_service', 'service_price',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.service_currency'
        db.add_column('tms_service', 'service_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tms.Currency'], null=True),
                      keep_default=False)

        # Deleting field 'Job.price'
        db.delete_column('tms_job', 'price')

        # Deleting field 'Job.currency'
        db.delete_column('tms_job', 'currency_id')
