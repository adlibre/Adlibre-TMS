...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.xero_contact_uid'
        db.delete_column('tms_customer', 'xero_contact_uid')

        # Adding field 'Customer.xero_contact_id'
        db.add_column('tms_customer', 'xero_contact_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Service.xero_item_id'
        db.add_column('tms_service', 'xero_item_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Customer.xero_contact_uid'
        db.add_column('tms_customer', 'xero_contact_uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Deleting field 'Customer.xero_contact_id'
        db.delete_column('tms_customer', 'xero_contact_id')

        # Deleting field 'Service.xero_item_id'
        db.delete_column('tms_service', 'xero_item_id')
    ...
    models = {
        ...
        'tms.customer': {
            ...
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tms.Currency']", 'null': 'True'}),
            ...
            'xero_contact_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'})
        },
        'tms.employee': {
        ...
        'tms.service': {
            ...
            'xero_item_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'})
        },
        'tms.timesheet': {
