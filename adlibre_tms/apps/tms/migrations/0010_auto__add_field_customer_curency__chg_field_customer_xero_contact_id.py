...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.xero_contact_id'
        db.alter_column('tms_customer', 'xero_contact_id', self.gf('django.db.models.fields.CharField')(max_length=36))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Customer.xero_contact_id'
        db.alter_column('tms_customer', 'xero_contact_id', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        'tms.customer': {
            ...
            'curency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tms.Currency']", 'null': 'True', 'blank': 'True'}),
