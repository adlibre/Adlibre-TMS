...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.xero_user_id'
        db.add_column('tms_employee', 'xero_user_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.xero_user_id'
        db.delete_column('tms_employee', 'xero_user_id')
    ...
    models = {
        ...
        'tms.employee': {
            ...
            'xero_user_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        'tms.expense': {
