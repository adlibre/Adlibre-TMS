...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'tms.service': {
            ...
            'service_currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tms.Currency']", 'null': 'True'}),
            'service_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'service_price': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'tms.timesheet': {
