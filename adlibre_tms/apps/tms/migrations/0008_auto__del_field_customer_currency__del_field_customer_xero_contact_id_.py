...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.xero_item_id'
        db.alter_column('tms_service', 'xero_item_id', self.gf('django.db.models.fields.CharField')(max_length=36))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Service.xero_item_id'
        db.alter_column('tms_service', 'xero_item_id', self.gf('django.db.models.fields.CharField')(max_length=32))
