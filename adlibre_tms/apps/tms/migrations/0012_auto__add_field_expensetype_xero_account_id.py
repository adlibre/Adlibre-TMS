...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpenseType.xero_account_id'
        db.add_column('tms_expensetype', 'xero_account_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpenseType.xero_account_id'
        db.delete_column('tms_expensetype', 'xero_account_id')
